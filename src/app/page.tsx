...
export default function Home() {
  ...
  // Lógica del Contador (23 de Septiembre)
  useEffect(() => {
    const targetDate = new Date(2026, 8, 23, 23, 59, 59).getTime(); // Mes 8 = Septiembre
  ...
  // Animación confinada SOLO al recuadro Hero Superior
  useEffect(() => {
    ...
    const render = () => {
      ...
      // Fondo morado del relámpago que iluminará el castillo
      if (flashAlpha > 0) {
  ...
  return (
    <main className="relative min-h-screen bg-black overflow-x-hidden flex flex-col items-center text-white selection:bg-purple-900 selection:text-green-300">
      <style>{`
        ...
        /* Difuminado inferior del Hero Box */
        .hero-mask {
      ...
      {/* 2. FONDO MAESTRO: Negro estático con iluminación tenue morada */}
      ...
      {/* 1. RECUADRO HERO ANIMADO SUPERIOR (Difuminado por debajo) */}
      <div ref={heroContainerRef} className="hero-mask relative w-full h-[65vh] min-h-[550px] overflow-hidden mt-16 z-10 flex flex-col items-center justify-center">
        ...
        {/* Silueta del Castillo (Reacciona a los rayos al estar detrás del color pero frente al canvas) */}
      ...
      <div className="relative z-20 flex flex-col items-center px-4 w-full max-w-6xl -mt-10 pb-20">
        ...
        {/* 4. MINI-ANUNCIO EBOOK (Limpio y directo) */}
        ...
        {/* 5. PORTAL REGISTRO Y APP WEB */}
        <PortalRegistro />

        {/* 6. CATÁLOGO GENERAL (Todos los recuadros) */}
        <CatalogoCompleto />
